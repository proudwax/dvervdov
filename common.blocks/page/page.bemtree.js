block('page').content()(function() {
    ...
    this.data = this.ctx.data = {
        ...
        promo: [
            ...
            { image: 'http://lorempixel.com/800/400/', text: 'Text 1', path: '#1' },
            { image: 'http://lorempixel.com/400/400/', text: 'Text 2', path: '#2' },
            { image: 'http://lorempixel.com/400/200/', text: 'Text 3', path: '#3' },
            { image: 'http://lorempixel.com/400/200/', text: 'Text 4', path: '#4' },
            { image: 'http://lorempixel.com/400/400/', text: 'Text 5', path: '#5' },
            { image: 'http://lorempixel.com/400/400/', text: 'Text 6', path: '#6' }
        ]
    };
